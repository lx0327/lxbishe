      ...
      >
        ...
        >
          ...
          <el-form-item label="标题">
            <el-input
              v-model="carousel.carousel_title"
              @keyup.enter.native="changecarousel(id)"
            ></el-input>
          </el-form-item>
          <el-form-item label="链接">
            <el-input
              v-model="carousel.carousel_url"
              @keyup.enter.native="changecarousel(id)"
            ></el-input>
          </el-form-item>
        </el-form>
